...
class Contact extends FrontendController
{
    ...
    */  
    public function contactCheck(){
        ...
        $res = $this->Contact_model->contactGetUser($email, $password);
    ...
    */  
    public function forgotPasswordSendEmail(){
        ...
        $res = $this->Contact_model->forgotPasswordGetUser($email);
