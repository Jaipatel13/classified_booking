                                ...
                                <div class="row form-group">
                                  ...
                                  <div class="row form-group">
                                    <div class="col-md-12">
                                      ...
                                      <input class="form-control" tabindex="2" type="password" name="New password" id="login_password" value="" placeholder="Password*" required="required">
                                    </div>
                                  </div>
                                  ...
                                  <div class="row form-group">
                                    <div class="col-md-12">
                                      ...
                                      <input class="form-control" tabindex="2" type="password" name="Confirm password" id="login_password" value="" placeholder="Password*" required="required">
                                    </div>
                                  </div>
                                                              
                                  <div class="row form-group">
                                    <div class="col-md-12">
                                      <input tabindex="2" type="button" name="submit"  id="forgot_password_submit" class="submit btn btn-primary py-2 px-4 text-white" value="Submit">
                                       <input tabindex="3" type="reset" name="reset" id="forgot_password_reset" class="submit btn btn-primary py-2 px-4 text-white" value="Reset">
                                    </div>
                                  </div>
                            </div>
            </form>
