<!-- Page title -->
        ...
        <div class="flat-row flat-general sidebar-right pad-bottom70px">
            <div class="cls_login_page container">
                <div class="row">
                    <div class="general">
                        <?php /* ?>
                        ...
                        <form id="login_form" class="cls_login_form" action="" method="post" data-bv-feedbackicons-valid="glyphicon glyphicon-ok" data-bv-feedbackicons-invalid="glyphicon glyphicon-remove" data-bv-feedbackicons-validating="glyphicon glyphicon-refresh">
                            <div class="quick-form">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <h5 class="flat-title-section style3 cls_login_h5">Login</h5>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <input tabindex="3" type="button" name="submit" id="login_submit" class="submit" value="submit">
                                        <input tabindex="4" type="reset" name="reset" id="login_reset" class="submit" value="reset">
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        Click below link
                                            <h5 class="cls_login_h5"><a class="cls_register_button_link" tabindex="5" href="<?php echo base_url(); ?>signup">REGISTER</a></h5>
                                        </p>
                                    </div>
                                </div>
                            </div><!-- /.quick-form -->
