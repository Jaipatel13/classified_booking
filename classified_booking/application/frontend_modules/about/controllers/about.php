...
class About extends FrontendController
{
    ...
    /* START: Functions for About
    */  
    public function aboutCheck(){
        ...
        $res = $this->About_model->aboutGetUser($email, $password);
    ...
    */  
    public function forgotPasswordSendEmail(){
        ...
        $res = $this->About_model->forgotPasswordGetUser($email);
